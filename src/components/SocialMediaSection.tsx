    ...
    <section className="py-16 bg-[#022C22] border-t border-emerald-900/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-emerald-300 text-sm mt-2 font-sans">Ikuti terus pembaruan berita, kajian, dan aktivitas Masjid Az-Zikra Sentul</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Instagram */}
          <a 
            href="https://www.instagram.com/azzikramediaofficial/" 
            target="_blank" 
          ...
          >
            ...
            <p className="text-emerald-300 text-xs mb-5 text-center">@azzikramediaofficial</p>
          ...
          {/* Facebook */}
          <a 
            href="https://www.facebook.com/masjidazzikrasentul/" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          >
            ...
            <p className="text-emerald-300 text-xs mb-5 text-center">Masjid Az-Zikra Sentul</p>
          ...
          {/* YouTube */}
          <a 
            href="https://www.youtube.com/@Azzikramedia" 
            target="_blank" 
            rel="noopener noreferrer"
          ...
          >
            ...
            <p className="text-emerald-300 text-xs mb-5 text-center">Azzikramedia</p>
