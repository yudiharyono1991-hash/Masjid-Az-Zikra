          ...
          {activeSubTab === 'quran' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                {/* Audio Status Banner */}
                {isPlayingAudio && (
                  <div className="bg-emerald-950/80 border border-emerald-500/40 text-emerald-200 px-4 py-2 rounded-xl text-xs flex items-center justify-between font-mono">
