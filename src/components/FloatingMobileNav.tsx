...
export const FloatingMobileNav: React.FC<FloatingMobileNavProps> = ({
  ...
  return (
    <nav className="xl:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#022C22]/95 border-t border-emerald-800/80 backdrop-blur-md px-2 py-1.5 shadow-2xl transition-all">
      <div className="flex items-center justify-around max-w-md mx-auto text-[9px] font-mono font-bold uppercase tracking-wider text-emerald-200">
        ...
        <button
          ...
          className="flex flex-col items-center gap-0.5 p-1.5 rounded-xl transition-all cursor-pointer text-emerald-300 hover:text-white"
        >
