...
export const SupabaseConfigModal: React.FC<SupabaseConfigModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-blue-950/80 backdrop-blur-md overflow-y-auto">
      <div className="bg-[#0b1329] border border-amber-500/30 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl relative text-blue-100 my-8">
        ...
        <form onSubmit={handleSave} className="p-6 space-y-5">
          <div className="bg-blue-900 p-4 rounded-2xl border border-blue-800 space-y-2 text-xs">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-blue-300 flex items-center gap-1.5 mb-1">
          ...
          <div className="pt-2 border-t border-blue-800 flex items-center justify-between">
            ...
            <button
              type="submit"
              className="bg-blue-500 hover:bg-blue-400 text-blue-950 font-bold px-5 py-2.5 rounded-xl text-xs flex items-center gap-1.5 cursor-pointer shadow-lg"
            >
