  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/80 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden my-auto">
        ...
        <div className="bg-[#064E3B] text-white p-4 sm:p-5 flex items-center justify-between shrink-0 border-b border-emerald-900">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="bg-amber-400 text-slate-950 hover:bg-amber-300 font-mono font-bold text-xs uppercase tracking-wider px-4 py-2 rounded-xl flex items-center gap-2 transition-all shadow-md cursor-pointer disabled:opacity-50"
            >
              {isGenerating ? (
                <>
        ...
        <div className="p-4 sm:p-8 overflow-y-auto space-y-6 bg-slate-100">
          <div className="flex justify-between items-center text-xs font-mono text-slate-700 pb-1">
          ...
          <div
            ref={pdfContainerRef}
            className="bg-white p-6 sm:p-12 border border-slate-300 rounded-2xl shadow-xl text-slate-900 space-y-8 max-w-[800px] mx-auto font-sans"
          >
            {/* Catalog Header */}
            <div className="border-b-2 border-[#064E3B] pb-6 flex flex-col sm:flex-row justify-between items-start gap-4">
              ...
              <div className="text-left sm:text-right font-mono text-[11px] text-slate-600 space-y-1 bg-slate-50 p-3 rounded-xl border border-slate-200">
            ...
            <div className="space-y-3">
              <h2 className="text-sm font-mono font-bold uppercase tracking-[0.2em] text-[#064E3B] border-b border-slate-200 pb-1.5 flex items-center gap-2">
                <History className="w-4 h-4 text-[#064E3B]" />
                1. Modul Menelusuri Sejarah Masjid Az-Zikra Sentul
              </h2>
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-2 text-xs">
                <p className="font-bold text-slate-900 font-serif">A. Profil Sejarah & Warisan KH. Muhammad Arifin Ilham</p>
                ...
                <div className="pt-2 border-t border-slate-200 flex flex-wrap items-center justify-between gap-2 font-mono text-[11px]">
                  ...
                  <span className="text-slate-400 italic">Coretan Catatan: ______________________</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 font-sans text-xs">
                {[
                  ...
                  <div key={index} className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2">
                    ...
                    <div className="pt-2 border-t border-slate-200 flex flex-wrap items-center justify-between gap-2 font-mono text-[10px]">
                      ...
                      <span className="text-slate-400 italic">Catatan Pemesan: ___________________________</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="p-4 bg-slate-50 border-2 border-dashed border-slate-300 rounded-2xl space-y-3">
              ...
              <div className="space-y-2 font-mono text-xs text-slate-400">
                <p className="border-b border-slate-300 pb-2">1. ____________________________________________________________________________________</p>
                <p className="border-b border-slate-300 pb-2">2. ____________________________________________________________________________________</p>
                <p className="border-b border-slate-300 pb-2">3. ____________________________________________________________________________________</p>
              </div>
            </div>
            ...
            {/* Footer Notice */}
            <div className="text-center font-mono text-[10px] text-slate-500 pt-4 border-t border-slate-200">
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-200 flex flex-wrap justify-between items-center gap-3 shrink-0 font-mono text-xs">
          <div className="text-slate-600 text-[11px] leading-tight">
            💡 <strong className="text-[#064E3B]">Cetak Katalog:</strong> Tekan <kbd className="bg-white px-1.5 py-0.5 rounded border border-slate-300 font-bold">Ctrl + P</kbd> lalu pilih <strong>"Save as PDF"</strong> untuk mengunduh versi cetak.
          </div>
          <div className="flex flex-wrap gap-2 ml-auto">
            <button
              onClick={handleDownloadHtml}
              className="px-3.5 py-2 bg-white text-[#064E3B] border border-[#064E3B]/30 rounded-xl hover:bg-slate-100 font-bold transition-colors cursor-pointer flex items-center gap-1.5"
            >
