...
interface LoginModalProps {
  ...
  onClose: () => void;
  session: UserSession;
  onLogin: (email: string, name: string, role: 'jamaah' | 'pengurus_dkm', phone?: string) => void;
  onLogout: () => void;
}
...
export const LoginModal: React.FC<LoginModalProps> = ({
  ...
  const [role, setRole] = useState<'jamaah' | 'pengurus_dkm'>('jamaah');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const finalName = name || (role === 'pengurus_dkm' ? 'Pengurus DKM Az-Zikra' : 'Jamaah Setia Az-Zikra');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-[#F9F8F4] border border-black/15 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl relative text-[#1A1A1A] my-8">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4 text-center py-6 my-auto">
              ...
              <div>
                ...
                <span className="bg-emerald-500/20 text-emerald-400 text-[10px] font-bold px-2.5 py-0.5 rounded mt-2 inline-block uppercase">
                  Akses {session.role === 'pengurus_dkm' ? 'Pengurus DKM' : 'Jamaah Terdaftar'}
                </span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 focus:border-amber-400 rounded-xl px-4 py-2.5 text-xs text-white outline-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 focus:border-amber-400 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white outline-none font-mono"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 focus:border-amber-400 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white outline-none"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold py-3 rounded-xl text-xs flex items-center justify-center gap-1.5 cursor-pointer shadow-lg shadow-amber-500/20"
              >
          ...
          <div className="bg-slate-900/90 border border-amber-500/20 p-5 rounded-2xl space-y-4 my-auto">
            <h4 className="text-sm font-bold font-serif text-amber-400 border-b border-slate-800 pb-2">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-[11px]">(Harian / Mingguan / Bulanan)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-[11px]">Hitung nisab zakat mal & penghasilan</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-[11px]">Laporan tanda terima resmi DKM</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-[11px]">Keanggotaan terverifikasi jamaah</p>
                </div>
              </div>
            </div>
          </div>
